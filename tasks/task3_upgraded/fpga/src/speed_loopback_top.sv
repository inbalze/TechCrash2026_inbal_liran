...
module speed_loopback_top(
    ...
    localparam [12:0] PAR_SETUP_CYC = 13'd500;   // 10 us at 50 MHz
    localparam [12:0] PAR_WR_HI_CYC = 13'd2500;  // 50 us at 50 MHz
    localparam [12:0] PAR_WR_LO_CYC = 13'd2500;  // 50 us at 50 MHz
